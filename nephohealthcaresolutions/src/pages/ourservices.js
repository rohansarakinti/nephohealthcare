        ...
        <section class="bg-white">
          <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
              <div class="max-w-screen-md mb-8 lg:mb-16">
                  <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">Explore the different services we offer</h2>
                  <p class="text-gray-500 sm:text-xl dark:text-gray-400">Here at Nepho we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
              </div>
              <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                  <div className='relative'>
                      ...
                      <div class="flex justify-center items-center rounded-full bg-primary-100 dark:bg-primary-900">
                          <img className="border border-4 border-[#fe6601] rounded-2xl shadow-2xl" src={jobPositionsHome} />
                      </div>
                      <div className='border border-4 border-[#fe6601] rounded-2xl shadow-2xl p-2 absolute top-3/4 left-1/4 w-full bg-white'> 
