...
function Footer() {
  return (
    <div>
        <section>
          <footer class="p-4 bg-[#fe6601] sm:p-6 ">
              <div class="mx-auto max-w-screen-xl">
                  <div class="md:flex md:justify-between">
                      ...
                      <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                          ...
                          <div>
                              <h2 class="mb-6 text-sm font-semibold text-white uppercase underline">Services</h2>
                              <ul class="text-white">
                                  <li class="mb-4">
                                      <a href="https://github.com/themesberg/flowbite" class="hover:underline ">Something</a>
                                  </li>
                                  <li>
                                      <a href="https://discord.gg/4eeurUVvTy" class="hover:underline">Something</a>
                                  </li>
                              </ul>
                          </div>
                          <div>
                              <h2 class="mb-6 text-sm font-semibold text-white uppercase underline">Contact Info</h2>
                              <ul class="text-white">
                                  <li class="mb-4">
                                      <a href="#" class="hover:underline">1234 Something pkwy, City, State</a>
                                  </li>
                                  <li class="mb-4">
